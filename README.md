...
If you want to use `APNS` token authentication you need to provide token and set `key_id` and `team_id` environment variables. To see how to obtain token and `key_id` read:
